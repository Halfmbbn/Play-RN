...
import isSameOrBetween from "dayjs/plugin/isSameOrBefore";
import isSameOrAfter from "dayjs/plugin/isSameOrAfter";

dayjs.extend(isBetween);
dayjs.extend(isSameOrBetween);
...
export const runPracticeDayjs = () => {
    ...
    const bDate = dayjs("2022-10-29 16:00:20");
    ...
    console.log("18. isAfter b,a", dayjs(aDate).isAfter(bDate));
